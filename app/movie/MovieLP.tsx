        ...
        <div className="container">
          ...
          <div className="story-editorial-list">
            {[
              {
                label: "STORY A",
                heading: "「自分には何もない」と思っていた私が、企業案件を手がけるクリエイターに",
                body: "「自分には何もない」と思っていました。でもここでPremiere Proに触れて、少しずつ動画が形になっていく喜びを知りました。スタッフの方が丁寧に教えてくれるので、未経験でも安心して取り組めています。今は自分の編集した動画が実際に企業様に届くのが、本当に楽しいです。",
                credit: "Aさん（未経験スタート）",
              },
              {
                label: "STORY B",
                heading: "趣味の動画制作が、企業案件という「本物の仕事」に変わった",
