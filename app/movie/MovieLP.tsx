    ...
    <>
      ...
      <header className="site-header" id="header">
        <div className="header-inner">
          ...
          <a href="https://lin.ee/Xq4oYCH" target="_blank" rel="noopener noreferrer" className="header-cta header-cta--line" id="header-cta-btn">
      ...
      <section className="final-cta" id="final-cta">
        <div className="container">
          ...
          <div className="reveal">
            <a href="https://lin.ee/Xq4oYCH" target="_blank" rel="noopener noreferrer" className="cta-btn cta-btn--line" id="main-cta-btn" role="button">
              {LINE_ICON}
              <span>LINEでお問い合わせ</span>
            </a>
          </div>
      ...
      <div className="float-cta" id="float-cta" aria-hidden="true">
        <a href="https://lin.ee/Xq4oYCH" target="_blank" rel="noopener noreferrer" className="float-cta-btn" id="float-cta-btn">
